...
from generating_algorithm.diversity_assessment import calculate_graph_edit_distance
...
G2 = WidgetGraph()
m1 = Node(1, 'a', '1', '1', '1')
G2.add_node(1, 'a', '1', '1', '1')
m2 = Node(2, 'b', '1', '1', '1')
G2.add_node(2, 'b', '1', '1', '1')
m3 = Node(3, 'a', '1', '1', '1')
G2.add_node(3, 'a', '1', '1', '1')
G2.add_edge(1, 2)
G2.add_edge(2, 3)

# g1 = widget_graph_to_networkx(G)
# g2 = widget_graph_to_networkx(G2)
# print(calculate_graph_edit_distance(g1=g1,g2=g2))


# g = widget_graph_to_networkx(G)
