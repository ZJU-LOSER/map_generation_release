...
class Info(object):
    ...
    # 文件存储
    mFILE_NAME = "AGM"
    mmFILE_NAME_M = "generation_test.m"
    ...
    mFILE_DIRECTORY = "D:\Desktop\map\Test_data\m_map/"
    pFILE_DIRECTORY = "D:\Desktop\map\Test_data\pkl/"
    rFILE_NAME = "AGM"
    rrFILE_NAME = "test1.m"
    rFILE_DIRECTORY = "D:\Desktop\map\Test_data\\r_map/"
    scFILE_DIRECTORY = "D:\Desktop\\rr\Assets\\"
    ...
    widgetcount = {
        json.dumps(st.dict1): 0, json.dumps(st.dict2): 0, json.dumps(st.dict3): 0, json.dumps(st.dict4): 0,
        json.dumps(st.dict5): 0, json.dumps(st.dict6): 0, json.dumps(st.dict7): 0,
        json.dumps(st.dict8): 0, json.dumps(st.dict9): 0, json.dumps(st.dict10): 0, json.dumps(st.dict11): 0,
        json.dumps(st.dict12): 0, json.dumps(st.dict13): 0, json.dumps(st.dict14): 0, json.dumps(st.dict15): 0,
        json.dumps(st.dict16): 0, json.dumps(st.dict17): 0, json.dumps(st.dict18): 0,
        ...
        json.dumps(ul.dict1_0): 0, json.dumps(ul.dict2_0): 0, json.dumps(ul.dict3_0): 0, json.dumps(ul.dict4_0): 0,
        json.dumps(ul.dict5_0): 0, json.dumps(ul.dict6_0): 0,
        json.dumps(ul.dict7_0): 0, json.dumps(ul.dict8_0): 0, json.dumps(ul.dict9_0): 0,
        json.dumps(ul.dict10_0): 0, json.dumps(ul.dict11_0): 0, json.dumps(ul.dict12_0): 0, json.dumps(ul.dict13_0): 0,
        json.dumps(ul.dict14_0): 0, json.dumps(ul.dict15_0): 0,
        json.dumps(ul.dict16_0): 0, json.dumps(ul.dict17_0): 0,
        json.dumps(ul.dict18_0): 0, json.dumps(ul.dict19_0): 0, json.dumps(ul.dict20_0): 0, json.dumps(ul.dict21_0): 0,
        json.dumps(ul.dict22_0): 0, json.dumps(ul.dict23_0): 0,
        json.dumps(ul.dict24_0): 0,

        json.dumps(ul.dict1_1): 0,
        json.dumps(ul.dict2_1): 0, json.dumps(ul.dict3_1): 0, json.dumps(ul.dict4_1): 0, json.dumps(ul.dict5_1): 0,
        json.dumps(ul.dict6_1): 0, json.dumps(ul.dict7_1): 0,
        json.dumps(ul.dict8_1): 0, json.dumps(ul.dict9_1): 0, json.dumps(ul.dict10_1): 0,
        json.dumps(ul.dict11_1): 0, json.dumps(ul.dict12_1): 0, json.dumps(ul.dict13_1): 0, json.dumps(ul.dict14_1): 0,
        json.dumps(ul.dict15_1): 0, json.dumps(ul.dict16_1): 0,
        json.dumps(ul.dict17_1): 0, json.dumps(ul.dict18_1): 0,
        json.dumps(ul.dict19_1): 0, json.dumps(ul.dict20_1): 0, json.dumps(ul.dict21_1): 0, json.dumps(ul.dict22_1): 0,
        json.dumps(ul.dict23_1): 0, json.dumps(ul.dict24_1): 0,

        json.dumps(cur.dict1_0): 0, json.dumps(cur.dict2_0): 0, json.dumps(cur.dict3_0): 0, json.dumps(cur.dict4_0): 0,
        json.dumps(cur.dict5_0): 0, json.dumps(cur.dict6_0): 0,
        json.dumps(cur.dict7_0): 0, json.dumps(cur.dict8_0): 0,
        json.dumps(cur.dict9_0): 0, json.dumps(cur.dict10_0): 0, json.dumps(cur.dict11_0): 0,
        json.dumps(cur.dict12_0): 0, json.dumps(cur.dict13_0): 0,
        json.dumps(cur.dict14_0): 0, json.dumps(cur.dict15_0): 0, json.dumps(cur.dict16_0): 0,
        json.dumps(cur.dict17_0): 0, json.dumps(cur.dict18_0): 0, json.dumps(cur.dict19_0): 0,
        json.dumps(cur.dict20_0): 0, json.dumps(cur.dict21_0): 0,
        json.dumps(cur.dict1_1): 0, json.dumps(cur.dict2_1): 0, json.dumps(cur.dict3_1): 0,
        json.dumps(cur.dict4_1): 0, json.dumps(cur.dict5_1): 0, json.dumps(cur.dict6_1): 0, json.dumps(cur.dict7_1): 0,
        json.dumps(cur.dict8_1): 0, json.dumps(cur.dict9_1): 0,
        json.dumps(cur.dict10_1): 0, json.dumps(cur.dict11_1): 0,
        json.dumps(cur.dict12_1): 0, json.dumps(cur.dict13_1): 0, json.dumps(cur.dict14_1): 0,
        json.dumps(cur.dict15_1): 0, json.dumps(cur.dict16_1): 0,
        json.dumps(cur.dict17_1): 0, json.dumps(cur.dict18_1): 0, json.dumps(cur.dict19_1): 0,
        json.dumps(cur.dict20_1): 0, json.dumps(cur.dict21_1): 0, json.dumps(cur.Sdict1_0): 0,
        json.dumps(cur.Sdict2_0): 0, json.dumps(cur.Sdict3_0): 0,
        json.dumps(cur.Sdict4_0): 0, json.dumps(cur.Sdict5_0): 0, json.dumps(cur.Sdict6_0): 0,
        json.dumps(cur.Sdict7_0): 0, json.dumps(cur.Sdict8_0): 0, json.dumps(cur.Sdict9_0): 0,
        json.dumps(cur.Sdict10_0): 0, json.dumps(cur.Sdict11_0): 0,
        json.dumps(cur.Sdict12_0): 0, json.dumps(cur.Sdict13_0): 0,
        json.dumps(cur.Sdict14_0): 0, json.dumps(cur.Sdict15_0): 0, json.dumps(cur.Sdict16_0): 0,
        json.dumps(cur.Sdict17_0): 0, json.dumps(cur.Sdict18_0): 0,
        json.dumps(cur.Sdict19_0): 0, json.dumps(cur.Sdict20_0): 0,
        json.dumps(cur.Sdict21_0): 0, json.dumps(cur.Sdict1_1): 0, json.dumps(cur.Sdict2_1): 0,
        json.dumps(cur.Sdict3_1): 0, json.dumps(cur.Sdict4_1): 0,
        json.dumps(cur.Sdict5_1): 0, json.dumps(cur.Sdict6_1): 0, json.dumps(cur.Sdict7_1): 0,
        json.dumps(cur.Sdict8_1): 0, json.dumps(cur.Sdict9_1): 0, json.dumps(cur.Sdict10_1): 0,
        json.dumps(cur.Sdict11_1): 0, json.dumps(cur.Sdict12_1): 0,
        json.dumps(cur.Sdict13_1): 0, json.dumps(cur.Sdict14_1): 0,
        json.dumps(cur.Sdict15_1): 0, json.dumps(cur.Sdict16_1): 0, json.dumps(cur.Sdict17_1): 0,
        json.dumps(cur.Sdict18_1): 0, json.dumps(cur.Sdict19_1): 0,
        json.dumps(cur.Sdict20_1): 0, json.dumps(cur.Sdict21_1): 0,
        json.dumps(cur.Bdict1_0): 0, json.dumps(cur.Bdict2_0): 0, json.dumps(cur.Bdict3_0): 0,
        json.dumps(cur.Bdict4_0): 0, json.dumps(cur.Bdict5_0): 0,
        json.dumps(cur.Bdict6_0): 0, json.dumps(cur.Bdict7_0): 0, json.dumps(cur.Bdict8_0): 0,
        json.dumps(cur.Bdict9_0): 0, json.dumps(cur.Bdict10_0): 0, json.dumps(cur.Bdict11_0): 0,
        json.dumps(cur.Bdict12_0): 0, json.dumps(cur.Bdict13_0): 0,
        json.dumps(cur.Bdict14_0): 0, json.dumps(cur.Bdict15_0): 0,
        json.dumps(cur.Bdict16_0): 0, json.dumps(cur.Bdict17_0): 0, json.dumps(cur.Bdict18_0): 0,
        json.dumps(cur.Bdict19_0): 0, json.dumps(cur.Bdict20_0): 0,
        json.dumps(cur.Bdict21_0): 0,
        json.dumps(ls.dict1): 0, json.dumps(ls.dict13): 0, json.dumps(ls.dict2): 0, json.dumps(ls.dict14): 0,
        json.dumps(ls.dict3): 0, json.dumps(ls.dict4): 0, json.dumps(ls.dict5): 0,
        ...
        json.dumps(fk.dict1): 0, json.dumps(fk.dict2): 0, json.dumps(fk.dict3): 0, json.dumps(fk.dict4): 0,
        json.dumps(fk.dict5): 0, json.dumps(fk.dict6): 0, json.dumps(fk.dict7): 0,
        json.dumps(fk.dict8): 0, json.dumps(fk.dict9): 0, json.dumps(fk.dict10): 0, json.dumps(fk.dict11): 0,
        json.dumps(fk.dict12): 0, json.dumps(fk.dict13): 0, json.dumps(fk.dict14): 0, json.dumps(fk.dict15): 0,
        json.dumps(fk.dict16): 0, json.dumps(fk.dict17): 0, json.dumps(fk.dict18): 0,
        json.dumps(fk.dict19): 0, json.dumps(fk.dict20): 0, json.dumps(fk.dict21): 0,
        json.dumps(fk.dict22): 0,
        json.dumps(ins.Intersectiondict1): 0, json.dumps(ins.Intersectiondict2): 0,
        json.dumps(ins.Intersectiondict3): 0,
        json.dumps(tj.Jdict1): 0, json.dumps(tj.Jdict2): 0, json.dumps(tj.Jdict3): 0, json.dumps(tj.Jdict4): 0,
        json.dumps(tj.Jdict5): 0, json.dumps(tj.Jdict6): 0, json.dumps(tj.Jdict7): 0,
        json.dumps(tj.Jdict8): 0, json.dumps(tj.Jdict9): 0, json.dumps(tj.Jdict10): 0, json.dumps(tj.Jdict11): 0,
        json.dumps(tj.Jdict12): 0, json.dumps(tj.Jdict13): 0,
        json.dumps(tj.Jdict14): 0, json.dumps(tj.Jdict15): 0, json.dumps(tj.Jdict16): 0, json.dumps(tj.Jdict17): 0,
        json.dumps(tj.Jdict18): 0, json.dumps(tj.Jdict19): 0,
        json.dumps(tj.Jdict20): 0, json.dumps(tj.Jdict21): 0, json.dumps(tj.Jdict22): 0, json.dumps(tj.Jdict23): 0,
        json.dumps(tj.Jdict24): 0, json.dumps(tj.Jdict25): 0,
...
for widget in Widgetlist:
    print(widget.get('Type') + '_' + widget.get('Flag'))
