...
class Fork(Widget):
    ...
    def get_Currents(self):
        ...
        # if self.Flag in DoubleList1:
        #     Currents_info["CurrentLanes"].extend([self.StartLaneID, self.StartLaneID + 1])
        #     Currents_info["Type"] = '单向虚线双行道'
        # if self.Flag in DoubleList2:
        #     Currents_info["CurrentLanes"].extend([self.StartLaneID, self.StartLaneID + 1])
        #     Currents_info["Type"] = '双向实线双行道'
        # if self.Flag in TripleList1:
        #     Currents_info["CurrentLanes"].extend([self.StartLaneID, self.StartLaneID + 1, self.StartLaneID + 2])
        #     Currents_info["Type"] = '一前行虚白线实黄线三行道'
        # if self.Flag in TripleList2:
        #     Currents_info["CurrentLanes"].extend([self.StartLaneID, self.StartLaneID + 1, self.StartLaneID + 2])
        #     Currents_info["Type"] = '二前行实黄线虚白线三行道'
        # if self.Flag in QuadrupleList:
    ...
    #靠近组件起点的左下角顶点开始，逆时针旋转，保存外接矩形的四个点
